...
ActiveRecord::Schema[7.0].define(version: 2022_11_22_143312) do
  ...
  create_table "paypal_transactions", force: :cascade do |t|
    t.bigint "user_property_id"
    t.string "order_id"
    t.date "date"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_property_id"], name: "index_paypal_transactions_on_user_property_id"
  end
